...
public class AddOrderCommand extends Command {
	...
	public String execute(HttpServletRequest request,
		...
		int carId = Integer.valueOf(car_id_s);
		...
		List<Car> carsInRent = manager.findCarsInRent();
		...
		List<Order> orders = manager.findOrdersByUserId(userId);
		...
		int price = getOrder.getOrderPrice();
