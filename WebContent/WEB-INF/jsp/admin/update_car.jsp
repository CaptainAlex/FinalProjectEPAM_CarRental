			...
			<%-- CONTENT --%>
				...
				title="Only numbers, max=2147483647"/><br/>
					...
					<fieldset >
						...
						<input type="text" name="carPrice" required pattern="\d{1,10}" min="0" max="2147483647" 
				title="Only numbers, max=2147483647"/><br/>
					</fieldset><br/>
					<fieldset >
						<legend><fmt:message key='update_car.priceDriver'/></legend>
						<input type="text" name="carDriverPrice" required pattern="\d{1,10}" min="0" max="2147483647" 
				title="Only numbers, max=2147483647"/><br/>
					</fieldset><br/>
